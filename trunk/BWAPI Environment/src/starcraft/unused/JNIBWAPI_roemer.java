 ...
 */
public class JNIBWAPI_roemer {
	
	// load the BWAPI client library
    static 
    {
    	//System.load("./ExternalLib/ExampleAIClient.dll");
        System.loadLibrary("ExampleAIClient");
    }
	
	/** callback listener for BWAPI events */
	protected BWAPIEventListener listener;
...
//	private ArrayList<Unit> playerUnits = new ArrayList<Unit>();
	...
	private native void startClient(JNIBWAPI_roemer jniBWAPI);	
	 ...
	 */
	public JNIBWAPI_roemer(BWAPIEventListener listener, int[] officerLocations ) {
